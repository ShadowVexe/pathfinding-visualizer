...
from .animations import AnimatingNode, Animator, Animation
...
class MazeGenerator:
    ...
    def randomized_prims_algorithm(self) -> None:
    ...
    def randomized_dfs(self) -> None:
        """Generate maze by randomized dfs
        """
